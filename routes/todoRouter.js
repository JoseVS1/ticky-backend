...
const updateTodoValidators = require("../middleware/updateTodoValidators");
...
todoRouter.put("/:id", authenticateToken, validateId, updateTodoValidators, handleValidationErrors, todoController.updateTodo);
